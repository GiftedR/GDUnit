...
@onready var TestPerLabel:Label = $vbc2_Action_List/hbc2_Actions/lbl2_Test_Percentage
@onready var TestPerSlider:HSlider = $vbc2_Action_List/hbc2_Actions/hsl2_Test_Percentage
@onready var TestResult:RichTextLabel = $vbc2_Action_List/rtl2_Test_Results
...
func _ready() -> void:
	TestPerSlider.value_changed.connect(_change_percentage)
	set_result_display()
